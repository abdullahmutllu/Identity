...
namespace IDentityProcess.Controllers
{
    ...
    public class AdminController : BaseController
    {
        ...
        public IActionResult RoleAssign(string id)
        {
            ...
            ViewBag.userName = user.UserName;  // ViewBag, Controller'da oluşturulan bir yapıyı View kısmına taşımak için kullanılır.
            IQueryable<AppRole> roles = roleManager.Roles; // veri tabanındaki rollerimizi getirir 
            List<string> userroles = userManager.GetRolesAsync(user).Result as List<string>; // kulanıcının sahip olduğu rolleri alırız
            ...
            foreach (var role in roles)
            {
                ...
                if (userroles.Contains(role.Name)) // kullanıcı veri tabanındaki rolleri içeriyorsa 
                {
